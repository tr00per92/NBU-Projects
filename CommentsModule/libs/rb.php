...
class AssociationManager extends Observable
{
	 ...
	 * OODB trash() method to remove the association links, thus giving FUSE dbManagers the
	 ...
	 * dbManagers about this. If you want to notify FUSE dbManagers about deletion use a foreach-loop
 ...
 * FUSE dbManagers. This Bean Helper makes use of the facade to obtain a
 ...
 * dbManagers. Models are connected to beans by naming conventions.
 * Actions on beans will result in actions on dbManagers.
 *
